# e_learning_platform/settings/base.py

"""
Base settings for e_learning_platform project.
...
# We need to point to the correct settings module for WSGI/ASGI
...
SUPABASE_PROJECT_URL = config('SUPABASE_PROJECT_URL')   # 👈 NAYA LINE


STORAGES = {
    "default": {
        "BACKEND": "e_learning_platform.storages.SupabasePublicStorage",   # 👈 CHANGE VAYO
    },
    "staticfiles": {
